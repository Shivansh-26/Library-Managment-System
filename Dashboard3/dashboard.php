...
<body>
    <div class="main">
        ...
        <div class="add--book">
            ...
            <div class="book--form">
                <h2>Add Book</h2>
                <form id="addBookForm" action="books.php" method="POST">
        ...
        <div class="issue--book">
            ...
            <div class="issue--form">
                ...
                <form id="issueBookForm" method="POST">
                    ...
                    <div class="form--element">
                        <button type="button" id="issueBookBtn">Issue</button>
                    </div>
                </form>
            </div>
        </div>
...
document.querySelector('.return--form button[type="button"]').addEventListener('click', returnBook);
