...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2024 at 11:34 AM
...
ALTER TABLE `issuebook`
  ADD PRIMARY KEY (`bookID`) USING BTREE,
  ADD UNIQUE KEY `bookID` (`bookID`,`stuID`,`issueDate`,`dueDate`,`fine`,`issueReturn`);
...
('root', '[{\"db\":\"lms\",\"table\":\"users\"},{\"db\":\"lms\",\"table\":\"students\"},{\"db\":\"lms\",\"table\":\"issuebook\"},{\"db\":\"lms\",\"table\":\"books\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__users\"}]');
...
('root', 'lms', 'books', '{\"sorted_col\":\"`publishYear` ASC\"}', '2024-04-21 08:57:27');
...
('root', '2024-04-21 09:32:00', '{\"Console\\/Mode\":\"collapse\"}');
